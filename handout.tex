...
Table \ref{t:s} contains data for a hypothetical area. This is analguous to the geographically aggregated 'wide' data shown in Figure~\ref{fmsim-schema}. \Cref{t:s2} illustrates
...
\citep{harland2013microsimulation}

...
an estimate of the amount of cake eaten in different wards in Leeds. The
...
data frame. More on this process is described in \citet{Lovelace+Cheshire2013}.
The final map result of `cakeMapPlot.R' is illustrated below (\cref{fcmap}).

\begin{figure}
 \centering
\includegraphics[width=15cm]{cakeMap}

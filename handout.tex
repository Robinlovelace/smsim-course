...
(IPF)
via selective sampling or the allocation of weights ,Lovelace2013-trs}.
The output is a \emph{spatial microdataset}.
The main methods for achieving  process is visualised in conceptual terms in \cref{fsmsim-schema}.
